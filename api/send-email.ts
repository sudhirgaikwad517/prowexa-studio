  ...
  try {
    ...
    switch (type) {
      case "contact":
        ...
        bodyHtml = `
          <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 28px 20px; color: #ffffff; background: #18181b;">
            ...
            <p style="font-size: 15px; line-height: 1.6; color: #e4e4e7;">Thank you for contacting Prowexa Technologies. We have logged your project request for <span style="color: #c084fc; font-weight: 700;">"${details.service || "Custom Software Engineering"}"</span>.</p>
            ...
            <div style="background: #27272a; border: 1px solid #3f3f46; border-left: 4px solid #a855f7; padding: 18px; border-radius: 12px; margin: 20px 0;">
              <div style="font-size: 11px; text-transform: uppercase; letter-spacing: 0.8px; color: #c084fc; font-weight: 700; margin-bottom: 6px;">Inquiry Summary</div>
            ...
            <p style="font-size: 15px; line-height: 1.6; color: #e4e4e7;">Our Senior Engineering Solutions Architect will review your requirement and reach out within 24 business hours.</p>
      ...
      case "job_application":
        ...
        bodyHtml = `
          <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 28px 20px; color: #ffffff; background: #18181b;">
            ...
            <p style="font-size: 15px; line-height: 1.6; color: #e4e4e7;">Thank you for applying for the <strong style="color: #c084fc;">${details.role || "Software Engineering Position"}</strong> role at Prowexa Technologies.</p>
            ...
            <div style="background: rgba(168, 85, 247, 0.12); border: 1px solid rgba(192, 132, 252, 0.3); padding: 18px; border-radius: 12px; margin: 20px 0;">
              ...
              <p style="font-size: 13px; color: #f3e8ff; margin: 0; line-height: 1.5;">Our talent acquisition team is actively evaluating applicant portfolios. If your qualifications match our current hiring roadmap, our recruiter will contact you to schedule an interview round.</p>
            </div>

            <p style="font-size: 15px; line-height: 1.6; color: #e4e4e7;">We appreciate your interest in building high-scale digital products with Prowexa.</p>
      ...
      case "blog_approved":
        ...
        bodyHtml = `
          <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 28px 20px; color: #ffffff; background: #18181b;">
            <h1 style="color: #ffffff; font-size: 22px; font-weight: 700; margin-top: 0; line-height: 1.3;">Blog Article Published! 🎉</h1>
            <p style="font-size: 15px; line-height: 1.6; color: #f4f4f5;">Hi <strong>${recipientName || "Author"}</strong>,</p>
            <p style="font-size: 15px; line-height: 1.6; color: #e4e4e7;">Great news! Your technical article titled <strong>"${details.title}"</strong> has been approved and officially published on Prowexa Engineering Blogs.</p>
      ...
      case "testimonial_approved":
        ...
        bodyHtml = `
          <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 28px 20px; color: #ffffff; background: #18181b;">
            <h1 style="color: #ffffff; font-size: 22px; font-weight: 700; margin-top: 0; line-height: 1.3;">Review Approved! 🌟</h1>
            <p style="font-size: 15px; line-height: 1.6; color: #f4f4f5;">Hi <strong>${recipientName || "Valued Contributor"}</strong>,</p>
            <p style="font-size: 15px; line-height: 1.6; color: #e4e4e7;">Thank you for sharing your experience! Your review has been approved and is featured live on our Testimonials page.</p>
      ...
      case "subscribe":
        ...
        bodyHtml = `
          <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 28px 20px; color: #ffffff; background: #18181b;">
            <h1 style="color: #ffffff; font-size: 22px; font-weight: 700; margin-top: 0; line-height: 1.3;">Welcome to Prowexa Engineering!</h1>
            <p style="font-size: 15px; line-height: 1.6; color: #e4e4e7;">Thank you for subscribing to Prowexa Tech Insights. You will receive curated software architecture breakdowns, React 19 guides, and AI engineering updates.</p>
            ${signatureHtml}
          </div>
        `;
        break;
    ...
    return res.status(200).json({
      success: true,
      message: `Crisp White Text Dark Purple MNC Email sent from ${fromAddress}!`,
    });
  } catch (error: any) {
