              ...
              if (type === "admin_otp") {
                ...
                bodyHtml = `
                  <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 32px 24px; color: #0f172a !important; background: #ffffff;">
                    ...
                    <p style="font-size: 15px; line-height: 1.6; color: #334155 !important;">Thank you for applying for the <strong>${details.role || "Software Position"}</strong> opportunity at Prowexa Technologies.</p>
                    ...
                    <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-left: 4px solid #9333ea; padding: 18px; border-radius: 12px; margin: 20px 0;">
                      ...
                      <p style="font-size: 13px; color: #334155 !important; margin: 0; line-height: 1.5;">Our engineering team is actively evaluating applicant portfolios. If your skills align with our current roadmap, our recruitment specialist will reach out to schedule an interview round.</p>
                    </div>
                ...
                bodyHtml = `
                  <div style="font-family: 'Segoe UI', Arial, sans-serif; padding: 32px 24px; color: #0f172a !important; background: #ffffff;">
                    ...
                    <p style="font-size: 15px; line-height: 1.6; color: #334155 !important;">Thank you for getting in touch with Prowexa Technologies. We have successfully logged your project request for <strong>"${details.service || "Custom Software Engineering"}"</strong>.</p>
                    ...
                    <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-left: 4px solid #0f172a; padding: 18px; border-radius: 12px; margin: 20px 0;">
                      <div style="font-size: 11px; text-transform: uppercase; color: #0f172a !important; font-weight: 700; margin-bottom: 6px;">Inquiry Summary</div>
